...
if __name__ == "__main__":
    ...
    for i in tqdm(df_meta.index):
        ...
        if not os.path.exists(join(cell_vit_contour_processed_dir, case_id, "stardist_results", "nuclei_stat_index.csv")):
            # Generate bash command
            bash_command = f"/home/zhihuang/anaconda3/envs/HEST/bin/python /project/zhihuanglab/yutong/HEST_project/scripts_zhi/feature_pre-calculation/main.py --slidepath '/project/zhihuanglab/common/datasets/HEST-1K/hest_data/wsis/{case_id}.tif' --stardist_dir '/project/zhihuanglab/yutong/HEST_project/results_zhi/processed_WSIs/{case_id}/stardist_results' --stage feature"
    ...
    bash_savedir = "/project/zhihuanglab/yutong/HEST_project/scripts_zhi/bash_p3"
...
#BSUB -J preprocess_{i:02d}
#BSUB -o {bash_savedir}/logs/preprocess_{i:02d}.out
#BSUB -e {bash_savedir}/logs/preprocess_{i:02d}.err
#BSUB -q normal
...
"""
        ...
        bash_file = join(bash_savedir, f"preprocess_{i:02d}.sh")
    ...
    with open(master_bash_file, 'w') as f:
        ...
        for i in range(n_process):
            bash_file = join(bash_savedir, f"preprocess_{i:02d}.sh")
            f.write(f"bsub -q gpu1 sh {bash_file} -o {bash_savedir}/logs/preprocess_{i:02d}.out\n")
